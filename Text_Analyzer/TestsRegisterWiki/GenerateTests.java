public abstract class GenerateTests implements Runnable {

        public static String Generare(String nume,String nume_fara_spatii, int i){

            nume.replaceAll(" ","");


            return "@Test\n" +
                    "    public void test" + i +"_"+nume+"(){\n" +
                    "       String AnimalsNames = \""+nume_fara_spatii+"\";\n" +
